...
with open('augmentation/augmentation_without_urdu_alignment/adjectives/adjective_aug_text_only_urdu.txt', 'r') as text_file, open(
        'augmentation/augmentation_without_urdu_alignment/adjectives/adjective_aug_sbn_only_urdu.txt', 'r') as sbn_file:
...
with open('augmentation/augmentation_without_urdu_alignment/adjectives/urdu_examples_with_adjectives.sbn', 'w') as combined_file:
